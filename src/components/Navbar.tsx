    ...
    >
      <div 
        className={cn(
          ...
          scrolled 
            ? "bg-white/90 backdrop-blur-md shadow-lg shadow-slate-200/40 border border-slate-100 rounded-full px-5 py-2" 
            : "bg-transparent px-4 py-4 xl:px-0"
        )}
      >
        <Link to="/" className="flex items-center gap-2 group">
          <div className={cn("flex items-center justify-center group-hover:scale-105 transition-all overflow-hidden shrink-0", scrolled ? "w-9 h-9" : "w-12 h-12")}>
